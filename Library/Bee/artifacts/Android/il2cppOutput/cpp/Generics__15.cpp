...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t Dictionary_2_EnsureCapacity_mAA39EA6716ED8F2159AB6C5689CD4557C00802A7_gshared (Dictionary_2_t311FE6772BE844D8DD6741B5F17F22B17B395341* __this, int32_t ___0_capacity, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_000b:
	{
		EntryU5BU5D_t15B58AD6B317A889CAC0426DB10237F6E7DFB92A* L_1 = __this->____entries;
		if (!L_1)
		{
			goto IL_001d;
		}
...
IL_0025:
	...
	}
	{
		int32_t L_7 = ___0_capacity;
		int32_t L_8;
		L_8 = Dictionary_2_Initialize_mA370A2CFE715DBCC68CB440768FE4B2AAE4D803B(__this, L_7, il2cpp_rgctx_method(method->klass->rgctx_data, 2));
		return L_8;
	}
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m1C716507BCD6896BEA76AA469256E12D81E01595(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 53));
		int32_t L_12 = V_1;
		return L_12;
	}
}
