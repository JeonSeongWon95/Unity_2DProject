...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_mBBCCD4EC70D1747519F76A7CDA40980A40A415D7(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 53));
		int32_t L_12 = V_1;
		return L_12;
	}
}
...
IL_0009:
	{
		...
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisTextureHandle_t87D7D063E5E22E38632961AB2B6F89978942BE09_m20DEB1F9955B6851058DD299DF91DEA7189B616C(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 57));
	}
	try
	{
		{
		...
		try
		{
			...
			Dictionary_2_set_Item_mB16CC417BFD9B9AE8376522B3F36A5A6F84287FF(__this, L_3, ((*(TextureHandle_t87D7D063E5E22E38632961AB2B6F89978942BE09*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 58));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
